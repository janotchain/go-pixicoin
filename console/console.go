...
// Welcome show summary of current pxc instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic pxc metadata
	fmt.Fprintf(c.printer, "Welcome to the pxc JavaScript console!\n\n")
	c.jsre.Run(`
