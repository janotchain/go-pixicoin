...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "pxc.ipc", false, filepath.Join(os.TempDir(), "pxc.ipc")},
		{"data", "pxc.ipc", false, "data/pxc.ipc"},
		{"data", "./pxc.ipc", false, "./pxc.ipc"},
		{"data", "/pxc.ipc", false, "/pxc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "pxc.ipc", true, `\\.\pipe\pxc.ipc`},
		{"data", "pxc.ipc", true, `\\.\pipe\pxc.ipc`},
		{"data", `\\.\pipe\pxc.ipc`, true, `\\.\pipe\pxc.ipc`},
	}
