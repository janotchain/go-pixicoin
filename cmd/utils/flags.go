...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		Name:  "networkid",
		Usage: "Network identifier (integer, 7762959=pixicoin, 7762955=Musictest)",
...
// for pxc and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. pxc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// pxc --keystore /tmp/mykeystore --lightkdf account new
//
