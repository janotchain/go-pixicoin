Name "pxc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
...
Section "pxc" pxc_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\pxc.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\pxc.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "pxc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "pxc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "pxc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "pxc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\pxc.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "pxc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\pxc.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "pxc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\pxc.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\pxc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\pxc.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${pxc_IDX}
    SectionGetSize ${pxc_IDX} $0
