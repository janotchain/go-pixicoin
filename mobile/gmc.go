...
// NodeConfig represents the collection of configuration values to fine tune the pxc
...
// Node represents a pxc Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new pxc node.
